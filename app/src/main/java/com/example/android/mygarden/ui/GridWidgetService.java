...
public class GridWidgetService extends RemoteViewsService {
    ...
    class GridRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
        ...
        public RemoteViews getViewAt(int position) {
            ...
            views.setImageViewResource(R.id.img_plant_widget, imgRes);
            views.setTextViewText(R.id.tv_plant_name, String.valueOf(plantId));
            // Always hide the water drop in GridView mode
            views.setViewVisibility(R.id.img_water_widget, View.GONE);
            ...
            views.setOnClickFillInIntent(R.id.img_plant_widget, fillInIntent);
